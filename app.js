            ...
            if (sunoMatch) {
                ...
                return `
                    <div style="background: linear-gradient(135deg, #ff6b6b, #4ecdc4, #45b7d1); padding: 20px; border-radius: 12px; margin: 12px 0;">
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 8px; padding: 16px; text-align: center;">
                            ...
                            <div style="font-size: 14px; color: rgba(255,255,255,0.8); margin-bottom: 12px;">
                                Click to listen on Suno
                            </div>
                            <a href="${url}" target="_blank" rel="noopener noreferrer" 
                               style="display: inline-block; background: rgba(255,255,255,0.2); color: white; text-decoration: none; padding: 10px 20px; border-radius: 6px; font-weight: 500; transition: all 0.2s ease;"
